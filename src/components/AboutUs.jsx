...
const AboutUs = () => {
    return (
        <section className="w-full py-32 bg-blush relative overflow-hidden">
            ...
            <div className="max-w-[1440px] mx-auto px-8 relative z-10">
                <motion.div
                    ...
                    className="w-full md:w-[80%] mx-auto relative p-[2px] rounded-3xl overflow-hidden"
                >
                    ...
                    {/* Card Content */}
                    <div className="relative bg-white/30 backdrop-blur-xl rounded-3xl p-12 md:p-20 border border-white/40 shadow-soft">
