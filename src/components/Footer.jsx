                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-gold hover:border-gold hover:scale-110 hover:shadow-lg hover:shadow-gold/30 transition-all duration-300 group"
                            >
                                <svg className="w-5 h-5 text-white/60 group-hover:text-midnight transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
